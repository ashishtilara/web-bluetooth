...
/*!********************************************!*\
  !*** ./src/app/heroes/heroes.component.ts ***!
  \********************************************/
/*! exports provided: E, HeroesComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var HeroesComponent = /** @class */ (function () {
    ...
    HeroesComponent.prototype.setListener = function (characteristic) {
        var _this = this;
        console.log('subscribe: ', characteristic);
        this.events.push({ id: '-', name: '> Subscribe' });
        characteristic.addEventListener('characteristicvaluechanged', function (event) {
            _this.counter++;
            _this.events.push({ id: _this.counter.toString(), name: '>> Clicked !!' });
        });
        characteristic.startNotifications()
            .then(function () {
            _this.events.push({ id: '-', name: '> Notifications started' });
        }).catch(function (error) {
            // And of course: error handling!
            console.error('Connection failed!', error);
        });
    };
    HeroesComponent.prototype.getCharacteristic = function (service) {
        var _this = this;
        service.getCharacteristics()
            .then(function (chars) {
            console.log(chars);
            _this.chars[service.uuid] = chars;
        })
            .catch(function (error) {
            // And of course: error handling!
            console.error('Connection failed!', error);
    ...
    HeroesComponent.prototype.onRegisterBluetooth = function () {
        var _this = this;
        // @ts-ignore
        navigator.bluetooth.requestDevice({ acceptAllDevices: true, optionalServices: [0xffe0] })
            .then(function (device) {
            // Step 2: Connect to it
            _this.events.push({ id: '-', name: '> connect' });
            _this.device = device;
            console.log(device);
            return device.gatt.connect();
        })
            .then(function (server) {
            _this.events.push({ id: '-', name: '> getPrimaryService' });
...
module.exports = __webpack_require__(/*! /Users/ashish/User/git/github/web-bluetooth-example/src/main.ts */"./src/main.ts");
